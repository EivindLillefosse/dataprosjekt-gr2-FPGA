...
proc dump_ip_config {ip_instance out_file} {
    ...
    # Try to get core IP properties (use catch in case property doesn't exist)
    foreach prop {NAME IPDEF VERSION_MAJOR VERSION_MINOR VLNV} {
    ...
    # Parse VLNV (Vendor:Library:Name:Version format)
    if {[dict get $metadata VLNV] != "unknown"} {
        set vlnv [dict get $metadata VLNV]
